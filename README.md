...
```
conda create -n XXXXXX python=3.8
...
4. Mask generation. Create masks for subsequent generation work.
...
2. The CSV file must contain two columns, image_name and label. A label of 1 indicates an abnormal diagnosis, and 0 indicates normal.
```
image_name,label
001.png,1
002.png,0
